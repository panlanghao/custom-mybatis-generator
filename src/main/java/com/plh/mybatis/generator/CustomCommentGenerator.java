package com.plh.mybatis.generator;
...
//        xmlElement.addElement(new TextElement("-->")); //$NON-NLS-1$
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        innerClass
                .addJavaDocLine(" * 1 This class was generated by MyBatis Generator."); //$NON-NLS-1$
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        innerClass.addJavaDocLine("/**"); //$NON-NLS-1$
        innerClass
                .addJavaDocLine(" * 2 This class was generated by MyBatis Generator."); //$NON-NLS-1$
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(" * 描述： "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append("表的实体类");
        topLevelClass.addJavaDocLine(sb.toString());
        topLevelClass.addJavaDocLine("* @author "+ (StringUtility.stringHasValue(App.AUTHOR)?App.AUTHOR:System.getProperties().getProperty("user.name")));
